...
ManiConvert brauzerdə işləyən Vite + React + TypeScript tətbiqidir. Şəkilləri fərqli formatlara çevirməyə, ölçülərini dəyişməyə və nəticəni dərhal endirməyə imkan verir. Fayllar serverə göndərilmir.

## Əsas xüsusiyyətlər

- PNG, JPG/JPEG, WEBP və SVG fayllarının yüklənməsi
- PNG, JPG və WEBP formatlarına çevirmə
- En və hündürlüyün aspect ratio qorunaraq və ya sərbəst dəyişdirilməsi
